...
class UncompletedTaskScreen extends StatefulWidget {
  ...
  @override
  State<UncompletedTaskScreen> createState() => _UncompletedTaskScreenState();
}

class _UncompletedTaskScreenState extends State<UncompletedTaskScreen> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: _firestore.collection('todos')
            ...
            .where('dueDate', isNull: true) // Only tasks without a due date
            .snapshots(),
          ...
          return Padding(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                // Add the ID to the task data for later use
